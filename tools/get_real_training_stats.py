...
malicious_labels = {
    "malicious", "Neris", "Cridex", "Tinba", "Shifu", "Geodo", "Virut", "Htbot", "Zeus", "Nsis-ay", "Miuref",
    "Qakbot", "Ursnif", "Hancitor", "Trickbot", "Dridex", "Emotet", "IcedID",
    "Artemis", "Cobalt", "PUA", "njRat"
}

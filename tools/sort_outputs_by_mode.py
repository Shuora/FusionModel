...
ROOT = os.path.abspath('C:\\Repositories\\Traffic\\CharBERT-MobileViT\\outputs')
MODE_TOKENS = ['attention_all_ensembles', 'concat_all_ensembles', 'attention_stacking', 'weighted_stacking', 'concat_stacking', 'attention_dim256', 'attention', 'concat', 'weighted']
EXT_WHITELIST = {'.png', '.pth', '.pkl', '.md', '.txt'}
TIMESTAMP = datetime.now().strftime('%Y%m%d_%H%M%S')
REPORT = {'root': ROOT, 'timestamp': TIMESTAMP, 'moved': [], 'skipped': []}

"""
(4) 图像和序列 concat 融合 + 集成学习 (XGBoost)
"""
...
def main() -> int:
    p = argparse.ArgumentParser(description="Concat fusion + XGBoost stacking")
    add_common_args(p)
    ...
    run_stacking_experiment(base_fusion_mode="concat", meta_methods=methods, ensemble_tag="concat_stacking", **kwargs)
    return 0
